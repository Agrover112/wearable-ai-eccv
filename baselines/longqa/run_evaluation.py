...
from longqa_utils import PROMPT_VARIANTS, apply_subset, normalize_answer
...
def _generate_longqa_preds(
    ...
    data = apply_subset(data, subset_file)
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="LongQA only: optional JSON subset file containing sample keys to run.",
    )
    parser.add_argument(
        "--prompt-variant",
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="LongQA only: ignore existing prediction file when generating.",
    )
    parser.add_argument(
        "--eval-output",
        type=str,
