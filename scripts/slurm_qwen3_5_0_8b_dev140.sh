#!/usr/bin/env bash
#SBATCH --job-name=qwen35-08b-dev140
...
RUN_DIR="$PROJECT_ROOT/runs/egolongqa/qwen3_5_0_8b_hf_uniform64_dev140_2026-07-30"
...
export QWEN35_VIDEO_TOTAL_PIXELS=25165824
