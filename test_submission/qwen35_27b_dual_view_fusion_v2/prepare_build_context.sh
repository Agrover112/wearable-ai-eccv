...
SUBMISSION="${ROOT}/test_submission/qwen35_27b_dual_view_fusion_v2"
DEST_ROOT="${1:-/scratch/inf0/user/agaur/wai-26/test_submission/qwen35_27b_dual_view_fusion_v2}"
...
echo "  ./build_image.sh --tag kth-saar-qwen35-dual-view:v2"
